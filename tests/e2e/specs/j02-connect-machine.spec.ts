...
test('J2 withdrawn Runtime routes are not discoverable and fail closed', async ({ page }) => {
  ...
  for (const route of ['/app/runtimes', '/app/runtimes/ci-machine', '/app/labs/runtimes']) {
