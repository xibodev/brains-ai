...
_IMPLEMENTED_TOOL_REGISTRY: dict[str, Callable[..., Any]] = {
    ...
    "work_assignment_accept": tools.work_assignment_accept_tool,
    "work_assignment_settle": tools.work_assignment_settle_tool,
    "work_assignment_cancel": tools.work_assignment_cancel_tool,
    "work_assignment_retry": tools.work_assignment_retry_tool,
    ...
    "claim_help_request": tools.claim_help_request_tool,
...
LEAN_TOOLS = frozenset(
    {
        ...
        "work_assignment_accept",
        "work_assignment_settle",
        "work_assignment_cancel",
        "work_assignment_retry",
        "inbox_wait",
    }
)
