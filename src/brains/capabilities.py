...
WITHDRAWN_CLI_GROUPS = frozenset({"daemon", "jobs", "operator"})
...
WITHDRAWN_HTTP_PATH_PREFIXES = (
    ...
    "/admin/test",
    "/v1/config",
    "/v1/admin/configuration/email",
    "/v1/admin/configuration/secrets",
    "/v1/admin/configuration/general",
    "/v1/operator/mailboxes/smtp",
    "/v1/operator/feedback",
    "/v1/operator/patterns",
    "/v1/operator/tools",
    "/v1/operator/topics",
    "/v1/orgs/{org}/members",
    "/v1/orgs/{org}/pods",
    "/v1/orgs/{org}/autopilots",
    "/v1/orgs/{org}/skills",
    "/v1/orgs/{org}/personas",
...
WITHDRAWN_HTTP_EXACT_PATHS = frozenset(
    {
        ...
        "/v1/workspaces/{slug}/messages",
        "/v1/sessions/{session_id}/commands",
        "/v1/sessions/{session_id}/state",
        "/v1/operator/workspaces/{slug}/messages",
        "/v1/orgs/onboard",
        "/v1/onboard",
