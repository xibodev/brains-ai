-- Brains frozen baseline schema for the sqlite backend.
--
...
CREATE TABLE IF NOT EXISTS squads (
	...
	FOREIGN KEY(workspace_id) REFERENCES workspaces (id), 
	FOREIGN KEY(leader_operator_id) REFERENCES operators (id), 
...
CREATE TABLE IF NOT EXISTS personas (
	...
	FOREIGN KEY(default_runtime_id) REFERENCES runtimes (id), 
	FOREIGN KEY(created_by_session_id) REFERENCES agent_sessions (id)
);
...
CREATE TABLE IF NOT EXISTS projects (
	...
	FOREIGN KEY(org_id) REFERENCES orgs (id), 
	FOREIGN KEY(workspace_id) REFERENCES workspaces (id), 
	FOREIGN KEY(assignee_pod_id) REFERENCES squads (id), 
	FOREIGN KEY(created_by_session_id) REFERENCES agent_sessions (id)
);
...
CREATE TABLE IF NOT EXISTS issues (
	...
	FOREIGN KEY(assignee_persona_id) REFERENCES personas (id), 
	FOREIGN KEY(assignee_pod_id) REFERENCES squads (id), 
	FOREIGN KEY(assignee_operator_id) REFERENCES operators (id), 
	FOREIGN KEY(created_by_session_id) REFERENCES agent_sessions (id)
);
