...
existing mail/tool-link row unchanged and records only its table/key plus an
`unverified` reason; no subject, body, address, owner, or credential is copied. Applying
