...
| B2 | Humans and agents can coordinate durable Workspace work across Sessions. | Start/register mailbox -> task/claim/message/handoff/help -> checkpoint -> proof-bound resume/end. | Supported CLI/MCP coordination and mailbox identity families plus `control/*`. | Session, task, claim, handoff, mailbox identity/attachment, help, checkpoint, and resume transitions with valid ownership and references; durable mailbox message delivery remains open. | BL-P0-05, BL-P1-12, BL-P1-14, BL-P1-17 | AC-B2-01..04; J5-J8, J10 |
