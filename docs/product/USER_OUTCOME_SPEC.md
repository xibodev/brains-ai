...
verification_basis: HEAD 2630f04e31ca47ff93eda1e2b616b3e657b0c877 plus static reconciliation of advertised Workspace-first outcomes, active experiments, and withdrawn execution capabilities; withdrawal implementation not verified; deployment not verified
-->
...
| B2 | Humans and agents can coordinate durable Workspace work across Sessions. | Start -> task/claim/message/handoff/help -> checkpoint -> resume/end. | Supported CLI/MCP coordination families and `control/*`. | Session, task, claim, handoff, mailbox, help, checkpoint, and resume transitions with valid ownership and references. | BL-P0-05, BL-P1-12, BL-P1-14, BL-P1-17 | AC-B2-01..04; J5-J8, J10 |
