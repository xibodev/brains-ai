...
| B8 | An operator can distinguish liveness from supported-product readiness and diagnose failures. | Probe -> inspect service, storage, queue, durable-mail, wiring, and recovery posture -> recover -> recheck. | `/health`, readiness, supervisor, queue diagnosis, and recovery policy. | Dependency-specific readiness fields; count-only mailbox registration/attachment/unread/local-notification classes including bounded reclaim and uncertainty; process role, listener/protocol state, queue health, and recovery result. | BL-P0-06, BL-P1-12, BL-P1-22 | AC-B8-01..04; J7, J11 |
...
- **Evidence:** F0, F3; B2, B4, B8; J7, J8, J11; BL-P1-12, BL-P1-22.
...
- **Then:** the decision is one-time and attributable, persists before publication,
  ...
  are withdrawn.
- **Evidence:** F3; B2, B4; J7, J8, J11; BL-P1-12, BL-P1-22.
...
- **Evidence:** F3; B2, B3, B8; J7, J8, J11; BL-P1-12, BL-P1-22.
...
- **Evidence:** F0, F3, F7; B2, B6, B8, B9; J7-J11; BL-P0-06, BL-P1-12, BL-P1-22.
...
- **Then:** the failed dependency is explicit, repair or rollback is bounded,
  ...
  declared ready.
- **Evidence:** B5, B6, B8; J11; BL-P0-06, BL-P1-12, BL-P1-22.
