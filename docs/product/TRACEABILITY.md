...
| F3 Sessions and HITL | P1, P4, P5, P7 | J7, J8, J11; AC-F3-01..07 | Inspect contextual Sessions, route/resolve decisions, coordinate continuity, stop when supported | `/app/governance`, `/app/coordination`, `/app/workspaces/:slug`; Labs Session evidence at `/app/labs/sessions*` | operator governance/coordination projections; Session commands; approval route/escalate/resolve; asks; `/v1/ws`; `/v1/events` | execution reconciliation plus leased coordination Session lifecycle, mailbox/successor continuity, decision routing/governance, realtime | `agent_sessions`, `session_leases`, `session_successors`, `approval_routing`, mailbox, commands/events/approvals; 121/123/132/133/142/143/145 | Lease, successor, decision-routing, control/API tests exist. No permanent chat dock is promised; shipped CLI interactive input remains unsupported. |
...
| B2 Coordination/MCP | P1, P3, P7 | J5-J8, J10; AC-B2-01..04 | Start/heartbeat/end, discover, task, claim, handoff, message, subscribe/read topic, checkpoint, resume/link successor | MCP SSE/stdio, CLI, `/app/coordination`, `/app/workspaces*`, `/app/act` | renewable Session leases, canonical reuse/successor transfer, interest-scoped topic announcements and cursors, scoped typed coordination adapters | coordination, knowledge, task, claim, mailbox, topics, `session_successors`, `session_leases`, `topic_announcements`, `topic_subscriptions`; 139/140/142-144 | Agent-comms, topic-delivery, lease/successor, and operator API suites cover scope, amplification, and continuity; stdio trust and per-tool destructive governance remain incomplete. |
...
| Governance/recovery | decision route/escalate/resolve, audit, governed actions, backup/restore | decision file/list/route/escalate/resolve, audit, governed-list, governed-sweep, audit-adopt, backup/restore, `db` migration + integrity family, exec-session | F3, B4, B5 |
...
| Governance | approval, `approval_routing`, handoff, task, claim, mailbox, snapshot, pattern, help, checkpoint, `topic_posts`, `topic_announcements`, `topic_subscriptions`, `session_successors`, `session_leases`, `governed_actions`, `audit_log`, `audit_chain_head` | 010, 030, 040, 070, 126-128, 139, 140, 142-145 | Audit/governance semantics remain transactional/fenced. Approval routing adds human-bound assignee/priority/due/escalation metadata without changing resolution; agent comms adds async harness help, interest-scoped topic cursors, successor continuity and renewable PID-less Session leases. Migration 140 narrowly converges one pre-release draft checksum, and every other edited migration fails closed. |
