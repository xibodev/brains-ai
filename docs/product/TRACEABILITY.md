...
| F3 Sessions and HITL | P1, P4, P5, P7 | J7, J8, J11; AC-F3-01..07 | Inspect contextual Sessions, resolve decisions, coordinate continuity, stop when supported | `/app/governance`, `/app/coordination`, `/app/workspaces/:slug`; Labs Session evidence at `/app/labs/sessions*` | operator governance/coordination projections; Session commands; approvals/asks; `/v1/ws`; `/v1/events` | execution reconciliation plus leased coordination Session lifecycle, mailbox/successor continuity, decisions, governance, realtime | `agent_sessions`, `session_leases`, `session_successors`, mailbox, commands/events/approvals; 121/123/132/133/142/143 | Lease, canonical-reuse, successor-transfer, control/API tests exist. No permanent chat dock is promised; shipped CLI interactive input remains unsupported. |
...
| Governance | approval, handoff, task, claim, mailbox, snapshot, pattern, help, checkpoint, `topic_posts`, `topic_announcements`, `topic_subscriptions`, `session_successors`, `session_leases`, `governed_actions`, `audit_log`, `audit_chain_head` | 010, 030, 040, 070, 126-128, 139, 140, 142-144 | Audit/governance semantics remain transactional/fenced. Agent comms adds harness help, one announcement per notifying topic post, per-Session topic cursors, successor continuity and renewable PID-less Session leases; migration 140 narrowly converges one pre-release draft checksum, and every other edited migration fails closed. |
