...
| B2 Coordination/MCP | P1, P3, P7 | J5-J8, J10; AC-B2-01..04 | Start/end, discover, task/claim/handoff/message, feedback report/enrich, topic, checkpoint/resume | MCP SSE/stdio, CLI, `/app/coordination`, `/app/workspaces*`, `/app/act` | feedback inbox, Session leases/successors, interest-scoped topics, typed coordination adapters | coordination, feedback, knowledge, tasks/claims/mailbox/topics/successors/leases; 139/140/142-146 | Feedback, async help, topic-delivery and Session-continuity suites cover scope/amplification; stdio trust remains incomplete. |
...
| Governance | approval/routing, feedback reports/enrichments/promotions, typed `event_contexts`, coordination queues, governed actions and audit chain | 010, 030, 040, 070, 126-128, 139, 140, 142-147 | Feedback promotion is exactly-once and audit-correlated; event category/scope provenance is stored per row and unresolved extension scope is explicit; approval routing never resolves; comms retains async help and Session continuity. |
