...
| CLI/wiring/service | `cli`, `wire`, `service`, supervisor | Install, wire Copilot/Claude/Codex/OpenCode, and operate Brains | B6 | Exact command/alias and per-harness generated wiring inventories are reviewed in both startup modes; browser host mutation contracts remain absent. |
