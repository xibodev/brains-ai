...
| Governance | approval/routing, feedback reports/enrichments/promotions, coordination queues, governed actions and audit chain | 010, 030, 040, 070, 126-128, 139, 140, 142-146 | Feedback promotion is exactly-once and audit-correlated; triage/promotion is human-bound while agents report/enrich. Approval routing never resolves; comms retains async help, topic cursors, successor continuity and Session leases. |
