...
| `/app/workspaces/:slug` | `Workspaces`, including Knowledge-tab source lookup | F0, F3, B2, B3, J5-J8, J11 | `:slug` is consumed; unauthorized and unknown Workspaces are both 404. Lookup distinguishes no match from an unreadable/missing root without exposing absolute result paths. |
